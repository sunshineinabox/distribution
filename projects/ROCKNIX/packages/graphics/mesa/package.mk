...
#
# freedreno stays in the host vulkan list though: fex-emu's makeinstall_target
# copies ${TOOLCHAIN}/lib/libvulkan_freedreno.so into the image, so dropping it
# leaves that cp with nothing to find on a toolchain built after this change.
PKG_MESON_OPTS_HOST="-Dglvnd=disabled \
                     -Dgallium-drivers= \
                     -Dplatforms= \
                     -Dglx=disabled \
                     -Dvulkan-drivers=imagination,freedreno \
